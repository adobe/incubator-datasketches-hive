...
@Description(
  ...
  extended = "Returns an approximation to the weighted probability mass function"
...
public class GetWeightedPmfFromDoublesSketchUDF extends UDF {
  ...
  public List<Double> evaluate(final BytesWritable serializedSketch, final Double... splitPoints) {
    ...
    final double[] pmf = sketch.getWeightedPMF(Util.objectsToPrimitives(splitPoints));
