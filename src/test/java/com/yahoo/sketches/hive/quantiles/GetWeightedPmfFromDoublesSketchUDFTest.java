...
public class GetWeightedPmfFromDoublesSketchUDFTest {

  @Test
  public void nullSketch() {
    List<Double> result = new GetWeightedPmfFromDoublesSketchUDF().evaluate(null, 0.0);
...
//
  ...
  public void normalCase() {
    ...
    sketch.update(3);
    sketch.update(4);
    List<Double> result = new GetWeightedPmfFromDoublesSketchUDF().evaluate(new BytesWritable(sketch.toByteArray()), 1.0, 3.0, 5.0);
    Assert.assertNotNull(result);
